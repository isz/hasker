...
class QuestionDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        answers=[]
        answer_paginator = Paginator(question.answers.order_by('-rating', 'date'), settings.ANSWERS_PER_PAGE)
    ...
    def get_queryset(self):
        try:
            ...
            if search_string.startswith('tag:'):
                ...
                queryset = self.model.objects.filter(title__icontains = search_string)|self.model.objects.filter(text__icontains = search_string)
...
class CreateAnswerView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        self.object.notify_question_owner(self.request)
        return reverse_lazy('qanda:question', args=(self.object.to_question.id,))
...
class VoteQuestionView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return render(request, self.template_name, context={'msg':'Error while vote'})
...
class CorrectAnswerView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return render(request, self.template_name, context={'msg':'Error while correct answer marking'})
